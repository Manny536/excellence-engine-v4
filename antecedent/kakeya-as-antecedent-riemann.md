...
Kakeya-geometric incidence is held as **prior structure** in the proposed dependency order of Riemann control. The exact zero-location bridge remains owed.
...
| Faithful κ / exact carrier bridge | OPEN |
| RH | OPEN |
